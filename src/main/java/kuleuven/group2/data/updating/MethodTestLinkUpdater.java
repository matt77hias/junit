...
public class MethodTestLinkUpdater extends Monitor{
	...
	//TODO: doen met een RunListener (inner class), en als een test start: alle links met die test flushen
	
	protected ICurrentRunningTestHolder currentRunningTestHolder;
	protected TestDatabase testDatabase;
	
	public MethodTestLinkUpdater(
			ICurrentRunningTestHolder currentRunningTestHolder, TestDatabase testDatabase,
